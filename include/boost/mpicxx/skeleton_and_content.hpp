...
#include <boost/mpicxx/packed_iarchive.hpp>
#include <boost/mpicxx/packed_oarchive.hpp>
#include <boost/mpicxx/detail/forward_skeleton_iarchive.hpp>
#include <boost/mpicxx/detail/forward_skeleton_oarchive.hpp>
#include <boost/mpicxx/detail/ignore_iprimitive.hpp>
#include <boost/mpicxx/detail/ignore_oprimitive.hpp>
...
namespace detail {
  typedef boost::mpicxx::detail::forward_skeleton_oarchive<boost::mpicxx::packed_skeleton_oarchive,boost::mpicxx::packed_oarchive> type1;
  typedef boost::mpicxx::detail::forward_skeleton_iarchive<boost::mpicxx::packed_skeleton_iarchive,boost::mpicxx::packed_iarchive> type2;
}


} } // end namespace boost::mpicxx

#include <boost/mpicxx/detail/content_oarchive.hpp>
...
#  include <boost/mpicxx/detail/communicator_sc.hpp>
#endif

// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::packed_skeleton_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::packed_skeleton_iarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::detail::type1)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::detail::type2)

BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(boost::mpicxx::packed_skeleton_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(boost::mpicxx::packed_skeleton_iarchive)
