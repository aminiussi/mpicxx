...
#include <boost/mpicxx/detail/packed_oprimitive.hpp>
#include <boost/mpicxx/detail/binary_buffer_oprimitive.hpp>
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::packed_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(boost::mpicxx::packed_oarchive)
