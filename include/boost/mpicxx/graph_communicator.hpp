 ...
 */
template<>
struct graph_traits<mpicxx::graph_communicator> {
  ...
  // Incidence Graph requirements
  typedef mpicxx::detail::comm_out_edge_iterator out_edge_iterator;
  typedef int degree_size_type;

  // Adjacency Graph requirements
  typedef mpicxx::detail::comm_adj_iterator adjacency_iterator;
  ...
  // Edge List Graph requirements
  typedef mpicxx::detail::comm_edge_iterator edge_iterator;
 ...
 */
template<>
struct property_map<mpicxx::graph_communicator, vertex_index_t>
{
