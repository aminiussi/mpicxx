...
#include <boost/mpicxx/detail/packed_iprimitive.hpp>
#include <boost/mpicxx/detail/binary_buffer_iprimitive.hpp>
...
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::packed_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(boost::mpicxx::packed_iarchive)
