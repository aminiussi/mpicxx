...
#include <boost/mpicxx/inplace.hpp>
#include <vector>
...
/**
 *  @brief Similar to boost::mpicxx::gather with the difference that the number
...
/**
 *  @brief Similar to boost::mpicxx::scatter with the difference that the number
