...
#include <boost/mpicxx/detail/ignore_skeleton_oarchive.hpp>
#include <boost/mpicxx/detail/mpi_datatype_primitive.hpp>
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::detail::mpi_datatype_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::detail::ignore_skeleton_oarchive<boost::mpicxx::detail::mpi_datatype_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(boost::mpicxx::detail::mpi_datatype_oarchive)
