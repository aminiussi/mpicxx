...
typedef boost::mpicxx::detail::forward_skeleton_oarchive<boost::mpicxx::text_skeleton_oarchive,boost::archive::text_oarchive> type3;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::text_skeleton_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::mpicxx::detail::type3)
