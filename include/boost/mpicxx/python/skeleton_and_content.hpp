...
#include <boost/mpicxx/python.hpp>
 ...
 */
class content : public boost::mpicxx::content
{
  typedef boost::mpicxx::content inherited;
...
namespace detail {
  ...
  struct do_get_content
  {
    content operator()(object value_obj) {
      ...
      return content(boost::mpicxx::get_content(value), value_obj);
    }
  };
